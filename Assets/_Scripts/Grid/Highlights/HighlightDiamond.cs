...
public class HighlightDiamond : Highlighter
{
    public override List<Cell> Highlight(Cell targetCell, int width, int length, Direction dir = Direction.Right)
    {
        ...
        {
            HighlightHorizontal(temp_up, width - i, ref h_cells);
            temp_up = temp_up.up;
        }
        ...
        {
            HighlightHorizontal(temp_down, width - i, ref h_cells);
        ...
        {
            HighlightVertical(temp_right, width - i, ref v_cells);
        ...
        {
            HighlightVertical(temp_left, width - i, ref v_cells);
